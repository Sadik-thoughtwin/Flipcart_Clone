      ...
      <div className="custom-style">
        ...
        <div>
          <img
            ...
            alt="imagestag"
          />
          <h3>Special PriceGet at flat ₹ {getId.price}</h3>
          ...
          <h3>
            {" "}
            Bank Offer10% off on Slice Cards, up to ₹200. On orders of ₹1000 and
            aboveT&C
          </h3>
          ...
          <img
            ...
            alt="imagestag"
          />
          <h3>Bank Offer5% Cashback on Flipkart Axis Bank CardT&C</h3>
        </div>
